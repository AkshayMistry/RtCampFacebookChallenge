...
<html>
	<head>
		<title>RtCampFacebookChallange</title>

		<link rel="shortcut icon" type="image/png" href="libs/resources/img/fav-icon.png"/>
	...
	<!-- Page Loder -->
		...
		if ( isset( $session ) ) {
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="col-xs-12 col-sm-3 text-center topUserName">
			...
			<!--Proile frame of facebook-->

			<div class="coverPhoto">
				<div class="container">
					<!-- in url set your cover image url-->
					<div class="col-md-12 photoBg" style="background:url(https://scontent.xx.fbcdn.net/v/t1.0-0/p180x540/38156656_246282406212675_4209780433614798848_o.jpg?_nc_cat=0&amp;oh=86186515db73e8ff11edca92e13e8bab&amp;oe=5C37C799);"></div>
					<!--in url set your Profile image -->
					<div class="profilePhoto"><img src="<?php echo 'https://graph.facebook.com/'.$user_id.'/picture';?>" class="img-circle" alt="profilePhotoo"></div>
					<div class="col-md-12 navigation">
						<ul>

						  <li><a href="#" id="download-all-albums">Download All</a><li>
						  <li><a href="google-index.php" id="move_all">Move</a></li>
						  <li><a href="google-index.php" id="move-selected-albums">Move All</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			template create by: <a href="/libs/resources/AKSHAYMISTRYRESUME.pdf" target="_blanck" title="Akshay Mistry">Akshay Mistry</a>
		</div>
		<?php
		} else {
